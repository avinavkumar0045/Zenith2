    ...
    <>
      ...
      <div className="absolute inset-0 z-20 pointer-events-none flex flex-col p-4 md:p-8">
        ...
        <div className="flex-1 w-full min-h-0 flex flex-col lg:flex-row items-stretch justify-between pb-4 lg:pb-0 gap-4 mt-auto lg:mt-0 pointer-events-none">
          ...
          <div className="flex flex-col gap-4 items-start w-full lg:w-[400px] xl:w-auto h-full min-h-0 pointer-events-none overflow-y-auto pr-2 pb-20 lg:pb-4">
            {/* <RecentLocations /> */}
          ...
          <div className="flex flex-col justify-end gap-4 items-end w-full lg:w-[350px] xl:w-96 pointer-events-none h-full overflow-y-auto">
            <SatelliteDetails />
            <ZenithControlCenter />
          </div>
        </div>
